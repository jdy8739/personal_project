    ...
    <div style="margin-top: 40px;">
        ...
        <div>
            <div class="row" style="width: 101%;">
                ...
                <img v-else class="responsive-img bigImgBlured" src="@/assets/img/DJ팁토.jpg"
                 @click="noticeFiltered"/>

                <concert-10 v-if="rock && filterDate('2021-09-12')"/>
                <img v-else class="responsive-img bigImgBlured" src="@/assets/img/이준형.jpeg"
                @click="noticeFiltered"/>

                <concert-11 v-if="hip_hop && filterDate('2021-09-12')"/>
                <img v-else class="responsive-img bigImgBlured" src="@/assets/img/Surl1.jpg"
                @click="noticeFiltered"/>

                <concert-12 v-if="jazz && filterDate('2021-09-18')"/>
                <img v-else class="responsive-img bigImgBlured" src="@/assets/img/Net Gala1.jpg"
                @click="noticeFiltered"/>
